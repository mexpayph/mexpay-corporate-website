        ...
        <SwiperSlide className="swiper-slide">
          ...
          >
            ...
            <p className="mil-mb-60 mil-up">
              MEXPay is not just a payments platform, it is a comprehensive
              solution. The global network, security and variety of options make
              MEXPay my number one option for all my quisque rutrum transactions.
      ...
      >
        <SwiperSlide className="swiper-slide">
          <blockquote className="mil-with-bg">
            ...
            <p className="mil-text-m mil-mb-30 mil-up">
              ...
              from MEXPay keep me informed in real time, giving me a feeling of
        ...
        <SwiperSlide className="swiper-slide">
          <blockquote className="mil-with-bg">
            ...
            <p className="mil-text-m mil-mb-30 mil-up">
              MEXPay Standard has proven to be more than a card; it is my
