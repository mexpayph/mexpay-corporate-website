...
const page = () => {
  return (
    <PlaxLayout bg={false}>
      <PageBanner
        title="Empower Your Business with MEXPay"
        pageName="Services"
      />
          ...
          <div className="row justify-content-between align-items-center">
            <div className="col-xl-5 mil-mb-80">
              ...
              <p className="mil-text-m mil-soft mil-mb-30 mil-up">
                Enable seamless digital transactions for your customers
              </p>
            </div>
        ...
        <div className="container">
          <div className="row flex-sm-row-reverse justify-content-between align-items-center">
            <div className="col-xl-5 mil-mb-80">
              ...
              <p className="mil-text-m mil-soft mil-mb-30 mil-up">
                Transfer salaries, vendor payments, and more effortlessly.
              </p>
            </div>
            <div className="col-xl-6 mil-mb-80">
      ...
      <div className="mil-features mil-p-0-80">
        <div className="container">
          <div className="row justify-content-between align-items-center">
            <div className="col-xl-5 mil-mb-80">
              <h2 className="mil-mb-30 mil-up">
                Financial Innovation, discover the MEXPay Virtual Card
              </h2>
              <p className="mil-text-m mil-soft mil-mb-30 mil-up">
